...
resource "aws_cloudwatch_metric_alarm" "database_cpu" {
  alarm_name          = "${var.database_identifier}-${var.environment}DatabaseServerCPUUtilization"
...
resource "aws_cloudwatch_metric_alarm" "database_disk_queue" {
  alarm_name          = "${var.database_identifier}-${var.environment}DatabaseServerDiskQueueDepth"
...
resource "aws_cloudwatch_metric_alarm" "database_disk_free" {
  alarm_name          = "${var.database_identifier}-${var.environment}DatabaseServerFreeStorageSpace"
...
resource "aws_cloudwatch_metric_alarm" "database_memory_free" {
  alarm_name          = "${var.database_identifier}-${var.environment}DatabaseServerFreeableMemory"
